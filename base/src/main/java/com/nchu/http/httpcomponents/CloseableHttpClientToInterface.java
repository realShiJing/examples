package com.nchu.http.httpcomponents;
...
/**
 * @Decription  CloseableHttpClient是在HttpClient的基础上修改更新而来的，这里还涉及到请求头token的设置（请求验证），
 *              利用fastjson转换请求或返回结果字符串为json格式，当然上面两种方式也是可以设置请求头token、json的
 * @Author yangsj
 * @Date 2020/3/2 18:10
 **/
public class CloseableHttpClientToInterface {
    ...
    public static String getToken(){
        ...
        try {
            ...
            HttpPost post = new HttpPost("http://tcc.taobao.com/cc/json/mobile_tel_segment.htm?tel=13026194071");
    ...
    public static void main(String[] args) {
        JSONObject object = new JSONObject();
        object.put("telephone", "12345678910");

        try {
            //首先获取token
            tokenString = getToken();
            String response = doPost("http://tcc.taobao.com/cc/json/mobile_tel_segment.htm?tel=13026194071", object);
