...
public class TestNIO_2 {
	...
	public void test7() throws IOException{
		SeekableByteChannel newByteChannel = Files.newByteChannel(Paths.get("2.jpg"), StandardOpenOption.READ);
		//获取指定目录下的所有子目录
	...
	public void test6() throws IOException{
		Path path = Paths.get("d:/document/example/1.jpg");
//		System.out.println(Files.exists(path, LinkOption.NOFOLLOW_LINKS));
	...
	public void test5() throws IOException{
		Path path1 = Paths.get("d:/document/example/1.jpg");
		Path path2 = Paths.get("d:/document/example/2.jpg");
	...
	public void test4() throws IOException{
		Path dir = Paths.get("d:/document/example/1.jpg");
//		Files.createDirectory(dir);
		
		Path file = Paths.get("d:/document/example/1.jpg");
//		Files.createFile(file);
	...
	/*	Path newPath = path.resolve("2.txt");
	...
	public void test1(){
		...
		System.out.println(path.endsWith("1.jpg"));
