package com.nchu.api.netty.protobuf;// Generated by the protocol buffer compiler.  DO NOT EDIT!
  ...
  private static final long serialVersionUID = 0L;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (!getSalaryBytes().isEmpty()) {
        com.google.protobuf.GeneratedMessageV3.writeString(output, 2, salary_);
      }
      unknownFields.writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      if (!getSalaryBytes().isEmpty()) {
        size += com.google.protobuf.GeneratedMessageV3.computeStringSize(2, salary_);
      }
      size += unknownFields.getSerializedSize();
      memoizedSize = size;
      return size;
