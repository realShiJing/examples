package com.nchu.transaction.notifymsg.bank1.service.impl;

import com.nchu.transaction.notifymsg.bank1.dao.AccountInfoDao;
import com.nchu.transaction.notifymsg.bank1.entity.AccountPay;
import com.nchu.transaction.notifymsg.bank1.model.AccountChangeEvent;
import com.nchu.transaction.notifymsg.bank1.service.AccountInfoService;
import com.nchu.transaction.notifymsg.bank1.spring.PayClient;
...
public class AccountInfoServiceImpl implements AccountInfoService {
    ...
    public AccountPay queryPayResult(String tx_no) {
        ...
        //幂等校验
        if(accountInfoDao.isExistTx(tx_no)>0){
            return payresult;
        }
        //远程调用
